from dm_app import db, FACILITY
from ..models import *
from ..globs import *
...
def create_offline_device_events(signum):
	ds = DBDevice.query.filter(DBDevice.patient_id != None, DBDevice.last_seen < (datetime.utcnow() - timedelta(seconds=ALERT_INTERVAL_SECONDS))).all()
	c = 0
